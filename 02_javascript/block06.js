...
EXERCISE 2
    ...
    // and returns an object which has the first arg oas a key and the second as value.
...
exercise 6
  ...
  //write a function called getIndex which find the index of an element in an array of objects, 
...
//EXERCISE 7
    ...
    //this object will contain three propreties, a start, and end and a a step.
    // according to these propreties it should push specific numbes to an array.
...
EXERCISE 10
    ...
    // Example schema
    schema = ["id", "name", "age"]
    // pleae note the schema is onnly an example here, I may be calling a different one form the test...
