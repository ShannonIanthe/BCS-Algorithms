...
EXERCISE 6
    ...
    // write  a function called numberConverter which takes an array as argument, it loops through the array and vheck if each element can be converted to a number, 
    //if they can be converted ti converts them, it also keeps track of how many can't be converted and it returns a string which outputs the result, as shown below.
