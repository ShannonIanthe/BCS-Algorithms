...
describe("#test2", function(){
    it ('swap(arr,arr2,2) should be [["banana","dvd-player","orange"],["tv","apple","playstation"]]', function(){
        assert.deepEqual(swap(["banana","apple","orange"], ["tv","dvd-player","playstation"], 1),[["banana","dvd-player","orange"],["tv","apple","playstation"]])
    })
})
describe("#test3", function(){
    it ('swap(arr,arr2,2) should be [["banana","apple","playstation"],["tv","dvd-player","orange"]]', function(){
        assert.deepEqual(swap(["banana","apple","orange"], ["tv","dvd-player","playstation"], 2),[["banana","apple","playstation"],["tv","dvd-player","orange"]])
    })
})
