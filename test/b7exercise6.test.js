...
var familyAffairs                    = require('../02_javascript/block7/exercise6.js').familyAffairs;
...
describe("#test2", function(){
    it ('familyAffairs should be  Yay! Jenny moved to Morenos', function(){
        assert.equal(familyAffairs(perfectFamily, otherFamilies1), `Yay! Jenny moved to Morenos`)
    })
})
describe("#test3", function(){
    it ('familyAffairs should be  Yay! Jenny moved to Smiths', function(){
        assert.equal(familyAffairs(perfectFamily, otherFamilies2), `Yay! Jenny moved to Smiths`)
    })
})
describe("#test4", function(){
    it ('familyAffairs should be Yay! Jenny moved to Tanakas', function(){
        assert.equal(familyAffairs(perfectFamily, otherFamilies3), `Yay! Jenny moved to Tanakas`)
    })
})
