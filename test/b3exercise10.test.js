...
var twoArrays                = require('../02_javascript/block3/exercise10').twoArrays
...
describe("#test1", function(){
    it ('twoArrays should be 2', function(){
...
describe("#test3", function(){
    it ('twoArrays should be 0', function(){
        assert.equal(twoArrays([3,5], [1, 4,5]), 0)
    })
})
describe("#test4", function(){
    it ('twoArrays should be 2', function(){
        assert.equal(twoArrays([3,5], ['3','5']), 2)
    })
})
